...
class F3Net(nn.Module):
    def __init__(self, num_classes=1, img_width=320, img_height=320, LFS_window_size=10, LFS_stride=2, LFS_M = 6, mode='FAD', device=None):
        ...
        self.fc = nn.Linear(4096 if self.mode == 'Both' or self.mode == 'Mix' else 1024, num_classes)
