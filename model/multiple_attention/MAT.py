...
from model.multiple_attention.xception import xception
from model.multiple_attention.efficientnet import EfficientNet
...
class MAT(nn.Module):
    ...
    dropout_rate=0.5,drop_final_rate=0.5, pretrained=False,alpha=0.05,size=(320,320),margin=1,inner_margin=[0.01,0.02]):
