...
class xception(nn.Module):
    def __init__(self,num_classes=2,pretrained='imagenet',escape=''):
        ...
        self.seq=[]
        self.seq.append(('b0',[self.conv1,self.bn1,self.relu1,self.conv2,self.bn2]))
        ...
        self.seq.append(('final',[self.conv3,self.bn3,self.relu3,self.conv4,self.bn4]))
...
if __name__ == '__main__':
    net = xception(num_classes=2,escape='b3')
    layers = net(torch.zeros(1,3,320,320))
    num_features = layers['b3'].shape[1]
    print(num_features)